...
toggle.addEventListener("click", function () {
  ...
  if (this.classList.toggle("bi-moon")) {
    ...
    document.getElementById("Welc").style.boxShadow =
      "rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px";
    document.getElementById("tarik").style.backgroundImage =
      "linear-gradient(whitesmoke,white)";
    document.getElementById("tarik").style.filter = "invert(0)";
    document.getElementById("menfess").style.backgroundImage =
      "linear-gradient(-45deg,#F4C183,#F4B446)";
    ...
    document.getElementById("Welc").style.boxShadow =
      "#E6E6E6 0px 10px 20px, #E6E6E6 0px 6px 6px";
    document.getElementById("tarik").style.backgroundImage =
      "linear-gradient(whitesmoke,#f8b500)";
    ...
    document.getElementById("box1").style.backgroundImage =
      "linear-gradient(to left top,rgba(0, 183, 255, 1), rgba(10, 123, 232, 1))";
    document.getElementById("box2").style.backgroundImage =
      "linear-gradient(to left top,rgba(0, 183, 255, 1), rgba(10, 123, 232, 1))";
    document.getElementById("box3").style.backgroundImage =
      "linear-gradient(to left top,rgba(0, 183, 255, 1), rgba(10, 123, 232, 1))";
    document.getElementById("box4").style.backgroundImage =
      "linear-gradient(to left top,rgba(0, 183, 255, 1), rgba(10, 123, 232, 1))";
    document.getElementById("menfess").style.backgroundImage =
      "linear-gradient(rgba(255, 219, 0, 1),rgba(150, 255, 0, 1))";
  }
});

function Alert() {
  Swal.fire("", "Gatau", "question");
}
